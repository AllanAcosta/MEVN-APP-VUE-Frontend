      ...
      axios.get('https://api-node.themesbrand.website/apps/task').then((data) => {
        ...
        data.data.data.forEach(row => {
          ...
          row.subItem.forEach(imag => {
            imag.image_src = 'https://api-node.themesbrand.website/fileupload/users_bucket/' + imag.img;
          })
            ...
            <form>
              <div class="row g-3">
                ...
                <div class="col-xxl-3 col-sm-4">
                  <flat-pickr v-model="date2" placeholder="Select date range" :config="rangeDateconfig"
